    ...
    <div class="site-width">
      ...
      <li class=" active">
                <ul>
                    ...
                    @endif
                    {{--<li>
                        <a href="{{route('stripe_payment')}}"><i class="icon-energy"></i> Payment Method</a>
                    </li>--}}
                    @if(Auth::user()->role_id == 1)
                    {{--
                        <li><a href="{{route('roles')}}"><i class="icon-layers"></i> Attributes</a></li>

                        <li><a href="{{route('services')}}"><i class="icon-wrench"></i> Service</a></li>--}}
                        ...
                        @foreach($sidebar_data as $side)
                            ...
                            @if(Auth::user()->role_id == 3)
                                ...
                                <li>
                                    ...
                                    <a href="{{route('invoiceView')}}" data-actor="{{$side}}">
                                        <i class="{{Helper::get_sidebar_icon($side)}}"></i>
                                        {{ucwords(str_replace('-', ' ',$side == 'packages' ? 'Services' : $side))}} 
                                    </a>
                            ...
                            @else
                                ...
                                <li>
                                    ...
                                    <a href="{{route('listing',$side)}}" data-actor="{{$side}}">
                                        <i class="{{Helper::get_sidebar_icon($side)}}"></i>
                                        {{ucwords(str_replace('-', ' ',$side == 'packages' ? 'Services' : $side))}} Management
                                    </a>
                    ...
                    <ul>
                        <li class="dropdown"><a href="#"><i class="icon-options"></i>Reports</a>
                            <ul class="sub-menu">
                                ...
                                <li>
                                    <a href="{{route('newsletter_manage')}}"><i class="icon-energy"></i> Manage Newletters</a>
                                </li>

                                <li>
                                    <a href="{{route('applied_job_view')}}"><i class="icon-energy"></i> Applied Jobs inquiry</a>
                                </li>
