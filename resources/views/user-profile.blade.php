                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" readonly="" disabled="" name="username" id="validationCustomUsername" placeholder="Username" aria-describedby="inputGroupPrepend" value="{{$user->username}}"
                                                           required>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="tel" class="form-control" name="emergency_number" data-inputmask="'mask': '0399-99999999'" id="validationCustomUsername" placeholder="Emergency Number"
                                                           aria-describedby="inputGroupPrepend" value="{{$user->emergency_number}}" required>
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="date" max="{{date('Y-m-d' , strtotime('-18 years'))}}" class="form-control" name="dob" id="validationCustomUsername" aria-describedby="inputGroupPrepend" value="{{$user->dob}}"
                                                           required>
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-8 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="residential_address" placeholder="Enter your Residential Address" id="validationCustomUsername" aria-describedby="inputGroupPrepend"
                                                           value="{{$user->residential_address}}" required>
                                                    <div class="invalid-feedback">
