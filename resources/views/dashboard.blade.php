                            ...
                            <div class="card-content border-bottom border-info border-w-5">
                                <div class="card-body p-4">                                   
                                    <div class="d-flex">                                        
                                        ...
                                        <div class="media-body align-self-center pl-3">
                                            <span class="mb-0 h6 font-w-600">MATERIAL</span><br>
                                ...
                                <div class="card-body p-4">   
                                    <div class="d-md-flex">
                                        ...
                                        <div class="content px-md-3 my-3 my-md-0">                                           
                                            <span class="mb-0 font-w-600 h5">{{Helper::config('websitename')}}</span><br>
                                            <p class="mb-0 font-w-500 tx-s-12">{{Helper::config('websiteslogan')}}</p>                                                    

                                        </div>
                                        <div class="my-auto">
                                            <a href="{{Helper::config('websitesurl')}}" class="btn btn-outline-primary font-w-600 my-auto text-nowrap">View Website</a>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body p-0">
                                    <ul class="list-group list-unstyled">
                                        <li class="p-4 border-bottom">
                                            ...
                                            <div class="media d-flex w-100">
                                                <div class="media-body align-self-center pl-2">
                                                    <span class="mb-0 font-w-600">New Connection</span><br>
