    ...
    <main>
        <div class="container-fluid site-width">
            ...
            @if($attributes && Helper::can_view($slug))
                <h3>{{ucwords($slug == 'packages' ? 'Services' : $slug)}}</h3>
                <div class="row">
                    ...
                    @foreach($attributes as $att)
                        ...
                        @else
                            $var_edit = "";
                        @endif
                        @if($att->attribute == $slug && $slug != "banner")
                            <div class="col-12 col-md-6 col-lg-3 mt-3 {{($slug == 'roles') ? 'role-assign-modal' : $var_edit }}" data-role_id="{{$att->id}}" data-rolename='{{$att->role}}' data-slug='{{$slug}}' style="cursor: pointer;">
                                        ...
                                        <div class="card-body p-4">
                                            <div class="d-flex">
                                                ...
                                                <div class="media-body align-self-center pl-3">
                                                    <span class="mb-0 h6 font-w-600">{{ $att->name == 'Packages' ? 'Services' : $att->name }}</span><br/>
                                                    <p class="mb-0 font-w-500 h6">{{ $att->role == 'Packages' ? 'Services' : $att->role }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-12 mt-3">
                        <div class="card">
                            <div class="card-header justify-content-between align-items-center">
                                <h4 class="card-title">{{ucwords($slug == 'packages' ? 'Services' : $slug)}} Report</h4>
                            </div>
                            <div class="card-body">
