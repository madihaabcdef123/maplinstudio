...
<script src="{{asset('web/owl-carousel/owl.carousel.js')}}"></script>
<script src="{{asset('web/js/royal_preloader.min.js')}}"></script>
...
$(document).on("click", ".clickable", function(){
    ...
    $.ajax({
        ...
        dataType : 'JSON',
        url: "{{route('modalform')}}",
        data: {desc:desc, wow_duration:wow_duration, wow_delay:wow_delay, slug:slug, class:clas, tag:tag, _token:"{{csrf_token()}}"},
...
<script type="text/javascript">
    ...
    (function($) { "use strict";
        ...
        var image = "{{asset('web/images/logo.png')}}";
        //Preloader
