        ...
        <div class="cont col-md-4">
            <div class="row">
                <div class="contact-info wow zoomInRight" data-wow-duration="2s" data-wow-delay="0.3s">
                    <div class="col-md-3">
                        <div class="cicle-icon">
                            <img src="{{asset('web/images/location-icon.png')}}" class="img-responsive" alt="">
                        </div>
                    </div>
                ...
                <div class="contact-info wow zoomInLeft" data-wow-duration="2s" data-wow-delay="0.3s">
                    <div class="col-md-3">
                        <div class="cicle-icon">
                            <img src="{{asset('web/images/phone.png')}}" class="img-responsive" alt="">
                        </div>
                    </div>
                    ...
                    <div class="col-md-9">
                        <div class="contact_text">
                            <h2>Phone</h2>
                            <p><a href="tel:{{Helper::config('contactnumber')}}">{{Helper::config('contactnumber')}}</a>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="contact-info wow zoomInLeft" data-wow-duration="2s" data-wow-delay="0.5s">
                    <div class="col-md-3">
                        <div class="cicle-icon">
                            <img src="{{asset('web/images/email-icon.png')}}" class="img-responsive" alt="">
                        </div>
                    </div>
                    ...
                    <div class="col-md-9">
                        <div class="contact_text">
                            <h2>Email</h2>
                            <p><a href="mailto:{{Helper::config('emailaddress')}}"
                                    class="email-text">{{Helper::config('emailaddress')}}</a></p>
                        </div>
                    </div>
                </div>
            </div>
