                    ...
                    <div class="sec_oneb wow fadeInLeft" data-wow-duration="2s" data-wow-delay="0.3s">
                        <div class="dts">
                            ...
                            <img src="<?php echo e(asset('web/images/1488.gif')); ?>" class="lazy"
                                data-src="<?php echo e(asset($studio->banner_img)); ?>" alt="" />
                            <div class="projet">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('web.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\abeer.khan\Desktop\huzaifa\maplin\resources\views/web/studio.blade.php ENDPATH**/ ?>