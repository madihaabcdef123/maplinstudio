    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                ...
                <!-- <img src="<?php echo e(asset((isset($banner) && isset($banner->img))?$banner->img:'web/images/bi.png')); ?>"
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                ...
                <div class="relative-dev">
                    ...
                    <img src="<?php echo e(asset($inner_banner_2->img)); ?>" alt="<?php echo e($inner_banner_2->details); ?>" class="relatve">
                </div>
            </div>
        </div>
...
<!-- <section class="exlusiveresidence">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6">
            <img src="<?php echo e(asset('web/images/exslusive-img.jpg')); ?>" alt="" width="100%" class="wow zoomInUp" data-wow-duration="2s" data-wow-delay="0.4s">
     ...
     <li>Inquiry Procedure, for the most complex applications and enforcements</li>
          ...
          <div class="col-md-6 col-sm-6">
            <img src="<?php echo e(asset('web/images/exslusive-img1.jpg')); ?>" alt="" width="100%" class="wow zoomInUp" data-wow-duration="2s" data-wow-delay="0.6s">
                ...
                <div class="owl-carousel wow fadeInUp" data-wow-delay="0.3s" data-wow-duration="1s" id="product3">
                    <div>
                        <div class="partner_box">
                            <a href="project.html"><img alt="img" src="<?php echo e(asset('web/images/exslusive-img.jpg')); ?>">
            ...
            <div class="container">
              <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-4">
                  <img src="<?php echo e(asset('web/images/img1.jpg')); ?>" class="img-responsive wow fadeInLeft" data-wow-delay="0.2s" alt="" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInLeft;">
                </div>

                <div class="col-xs-12 col-sm-8 col-md-8">
                   <div class="col-xs-12 col-sm-12 col-md-12 padding-zero">
                      <img src="<?php echo e(asset('web/images/img2.jpg')); ?>" class="img-responsive wow fadeInUp" data-wow-delay="0.2s" alt="" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                    </div>

              <div class="col-xs-12 col-sm-6 col-md-6 padding-zero">
              <img src="<?php echo e(asset('web/images/surveygrading.jpg')); ?>" class="img-responsive wow fadeInUp" data-wow-delay="0.4s" alt="" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">
              </div>

                      <div class="col-xs-12 col-sm-6 col-md-6 padding-zero">
                         <img src="<?php echo e(asset('web/images/img4.jpg')); ?>" class="img-responsive wow fadeInUp" data-wow-delay="0.6s" alt="" style="visibility: visible; animation-delay: 0.6s; animation-name: fadeInUp;">
                      </div>
                </div>
              </div>
            </div>
...
<?php echo $__env->make('web.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\abeer.khan\Desktop\huzaifa\maplin\resources\views/web/planning.blade.php ENDPATH**/ ?>