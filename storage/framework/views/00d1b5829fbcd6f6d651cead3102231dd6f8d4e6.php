    ...
    <main>
        <div class="container-fluid site-width">
            ...
            <?php if($attributes && Helper::can_view($slug)): ?>
                <h3><?php echo e(ucwords($slug == 'packages' ? 'Services' : $slug)); ?></h3>
                <div class="row">

                    <?php $__currentLoopData = $attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $att): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(Helper::can_edit($slug)): ?>
                            <?php
                                $var_edit = "updateevent";
                            ?>
                        <?php else: ?>
                            $var_edit = "";
                        <?php endif; ?>
                        <?php if($att->attribute == $slug && $slug != "banner"): ?>
                            <div class="col-12 col-md-6 col-lg-3 mt-3 <?php echo e(($slug == 'roles') ? 'role-assign-modal' : $var_edit); ?>" data-role_id="<?php echo e($att->id); ?>" data-rolename='<?php echo e($att->role); ?>' data-slug='<?php echo e($slug); ?>' style="cursor: pointer;">
                                        ...
                                        <div class="card-body p-4">
                                            <div class="d-flex">
                                                ...
                                                <div class="media-body align-self-center pl-3">
                                                    <span class="mb-0 h6 font-w-600"><?php echo e($att->name == 'Packages' ? 'Services' : $att->name); ?></span><br/>
                                                    <p class="mb-0 font-w-500 h6"><?php echo e($att->role == 'Packages' ? 'Services' : $att->role); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-12 mt-3">
                        <div class="card">
                            <div class="card-header justify-content-between align-items-center">
                                <h4 class="card-title"><?php echo e(ucwords($slug == 'packages' ? 'Services' : $slug)); ?> Report</h4>
                            </div>
                            <div class="card-body">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/maplin/resources/views/roles/crud.blade.php ENDPATH**/ ?>