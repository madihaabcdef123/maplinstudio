        ...
        <div class="carousel slide" data-ride="carousel" id="carousel-example-generic">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    ...
                    <img src="<?php echo e(asset('web/images/808.gif')); ?>" class="head_lazy" data-src="<?php echo e(asset((isset($banner) && isset($banner->img))?$banner->img:'web/images/abt_ban.png')); ?>" width="100%">
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="main-img">
                        <div class="relative-dev">
                            ...
                            <div class="video-counselling-box wow zoomIn" data-wow-duration="2s" data-wow-delay="0.3s" style="visibility: visible; animation-duration: 2s; animation-delay: 0.3s; animation-name: zoomIn;">
                                <img src="<?php echo e(asset($inner_banner_1->img)); ?>" class="img-responsive" alt="<?php echo e($inner_banner_1->details); ?>">
                                <div class="overlay-counselling-video">
                                    <a data-fancybox="" href="<?php echo e(Helper::config('websitestourguide')); ?>"><img src="<?php echo e(asset('web/images/play-btn.png')); ?>" class="img-responsive" alt=""></a>
                                </div>
                            </div>
    ...
    <div class="partners_section">
        <div class="container">
            ...
            <div class="partners_slider">
                <div class="row">
                    <div class="owl-carousel wow fadeInUp divAlign" data-wow-delay="0.3s" data-wow-duration="1s" id="product2">
                        <?php if($teams): ?>
                        ...
                        <div>
                            <div class="partner_box divAlign">
                                <a href="javascript:void(0)">
                                    ...
                                    <img src="<?php echo e(asset('web/images/1488.gif')); ?>" class="lazy" data-src="<?php echo e(asset($team->img)); ?>" alt="<?php echo e($team->name); ?>" />
...
<?php echo $__env->make('web.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/maplin/resources/views/web/about.blade.php ENDPATH**/ ?>