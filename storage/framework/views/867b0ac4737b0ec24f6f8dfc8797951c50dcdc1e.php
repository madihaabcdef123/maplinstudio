            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    ...
                    <div class="carousel-caption"> -->
                        ...
                        <img src="<?php echo e(asset('web/images/808.gif')); ?>" class="head_lazy" data-src="<?php echo e(asset((isset($banner) && isset($banner->img))?$banner->img:'web/images/Layer-22.png')); ?>" alt="<?php echo e(((isset($banner) && isset($banner->name))?$banner->name:Helper::config('websitename'))); ?>" width="100%">
        ...
        <div class="container">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" role="tab" id="freshness">
                                <h4 class="panel-title">
                                    <a role="button" data-toggle="collapse" data-parent="#accordion" href="#fresh" aria-expanded="true" aria-controls="collapseOne">
                                        Freshness <i class="fa fa-angle-down" aria-hidden="true"></i>
                                    </a>
                                </h4>
                            </div>
                            <div id="fresh" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="freshness">
                                <div class="panel-body">
                                    <label class="checkMain">Last 30 days
                                        <input type="checkbox" class="freshness" name="freshness" data-policy="less" value="30">
                                        <span class="checkmark"></span>
                                    </label>
                                    <label class="checkMain">Last 15 days
                                        <input type="checkbox" class="freshness" name="freshness" data-policy="less" value="15">
                                        <span class="checkmark"></span>
                                    </label>
                                    <label class="checkMain">Last 7 days
                                        <input type="checkbox" class="freshness" name="freshness" data-policy="less" value="7">
                                        <span class="checkmark"></span>
                                    </label>
                                    <label class="checkMain">Last 3 days
                                        <input type="checkbox" class="freshness" name="freshness" data-policy="less" value="3">
                                        <span class="checkmark"></span>
                                    </label>
                                    <label class="checkMain">Today
                                        <input type="checkbox" class="freshness" name="freshness" data-policy="less" value="0">
                                        <span class="checkmark"></span>
                                    </label>
                                </div>
                            </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <?php if($job_title): ?>
                                        ...
                                        <label class="checkMain"><?php echo e($val->job_title); ?>
                                            ...
                                            <input type="checkbox" class="job_title" data-policy="same" value="<?php echo e($val->job_title); ?>">
                                            <span class="checkmark"></span>
                                        </label>
                            ...
                            <div id="collapseThree" class="panel-collapse collapse  in" role="tabpanel" aria-labelledby="headingThree">
                                <div class="panel-body">
                                    <label class="checkMain">Fresh
                                        <input type="checkbox" class="experience" data-policy="less" data-policy="less" value="0">
                                        <span class="checkmark"></span>
                                    </label>
                                ...
                                <div class="panel-body">
                                    <?php if($job_type): ?>
                                        ...
                                        <label class="checkMain"><?php echo e($type->employment_type); ?>
                                            ...
                                            <input type="checkbox" class="job_type" data-policy="same" value="<?php echo e($type->employment_type); ?>">
                                            <span class="checkmark"></span>
                                        </label>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>
                                ...
                                <div class="panel-body">
                                    <?php if($working_location): ?>
                                        ...
                                        <label class="checkMain"><?php echo e($location->role_location); ?>
                                            ...
                                            <input type="checkbox" class="role_location" data-policy="same" value="<?php echo e($location->role_location); ?>">
                                            <span class="checkmark"></span>
                                        </label>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>
            ...
            <div class="col-md-9 col-xs-12 col-sm-9 n-featured-jobs">
                <div class="n-featured-job-boxes wow fadeInRight" data-wow-delay="0.3s" data-wow-duration="2s">
                    ...
                    ?>
                    <div class="n-job-single all-careers" data-job_title="<?php echo e($value->job_title); ?>" data-city="<?php echo e($value->city); ?>" data-freshness="<?php echo e($freshness); ?>" data-experience="<?php echo e($value->experience); ?>" data-skills="<?php echo e($value->skills); ?>" data-job_type="<?php echo e($value->employment_type); ?>" data-role_location="<?php echo e($value->role_location); ?>">

                        <div class="n-job-detail">
                            <ul class="list-inline">
                                <li class="n-job-title-box">
                                    <h4><a href="<?php echo e(route('career_detail',$value->id)); ?>"><?php echo e($value->job_title); ?></a> <i class="fa fa-star"></i></h4>
                                    ...
                                    <p><span><i class="fa fa-calendar" aria-hidden="true"></i>  <a href=""> <?php echo e(date("M d,Y" , strtotime($value->created_at))); ?></a> <i class="fa fa-money"></i>
                                    <a href=""> <?php echo e($value->starting_salary); ?> - <?php echo e($value->ending_salary); ?></a></span>
                                    </p>
                                </li>
                            </ul>
                        </div>
...
<?php echo $__env->make('web.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/maplin/resources/views/web/career.blade.php ENDPATH**/ ?>