            ...
            <div class="modal-body">
                <p class="statusMsg"></p>
                    ...
                    <input type="hidden" id="job_id" name="job_id" value="<?php echo e($job->id); ?>" >
                     <input type="hidden" id="job_id" name="user_id" value="<?php echo e($user->id); ?>" >
                    <div class="form-group">
                        <label for="inputName">Name</label>
                        <input type="text" class="form-control" id="inputName" name="name" value="<?php echo e($user->name); ?>" placeholder="Enter your name"/>
                    </div>
                    <div class="form-group">
                        <label for="inputEmail">Email</label>
                        <input type="email" class="form-control" name="email"  value="<?php echo e($user->email); ?>" id="inputEmail" placeholder="Enter your email"/>
                    </div>

                    <div class="form-group">
                        <label for="inputEmail">Contact Number</label>
                        <input type="number" class="form-control" name="contactno"  value="<?php echo e($user->phonenumber); ?>" id="inputNumber" placeholder="Enter your Contact Number"/>
                    </div>
...
// }
 ...
 <?php $__env->stopSection(); ?>
<?php /**PATH C:\Users\abeer.khan\Desktop\huzaifa\maplin\resources\views/web/extends/modal.blade.php ENDPATH**/ ?>