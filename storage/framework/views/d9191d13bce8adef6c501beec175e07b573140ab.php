                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" readonly="" disabled="" name="username" id="validationCustomUsername" placeholder="Username" aria-describedby="inputGroupPrepend" value="<?php echo e($user->username); ?>"
                                                           required>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="tel" class="form-control" name="phonenumber" id="validationCustomUsername" placeholder="Contact Number" data-inputmask="'mask': '0399-99999999'" aria-describedby="inputGroupPrepend"
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="tel" class="form-control" name="emergency_number" data-inputmask="'mask': '0399-99999999'" id="validationCustomUsername" placeholder="Emergency Number"
                                                           aria-describedby="inputGroupPrepend" value="<?php echo e($user->emergency_number); ?>" required>
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="date" max="<?php echo e(date('Y-m-d' , strtotime('-18 years'))); ?>" class="form-control" name="dob" id="validationCustomUsername" aria-describedby="inputGroupPrepend" value="<?php echo e($user->dob); ?>"
                                                           required>
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-8 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="residential_address" placeholder="Enter your Residential Address" id="validationCustomUsername" aria-describedby="inputGroupPrepend"
                                                           value="<?php echo e($user->residential_address); ?>" required>
                                                    <div class="invalid-feedback">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\abeer.khan\Desktop\huzaifa\maplin\resources\views/user-profile.blade.php ENDPATH**/ ?>