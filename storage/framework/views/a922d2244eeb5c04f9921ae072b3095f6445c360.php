<?php $__env->startSection('content'); ?>
        ...
        <div class="carousel slide" data-ride="carousel" id="carousel-example-generic">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    ...
                    <img src="<?php echo e(asset('web/images/808.gif')); ?>" class="head_lazy" data-src="<?php echo e(asset((isset($banner) && isset($banner->img))?$banner->img:'web/images/expert-ban.png')); ?>" >


                    <div class="carousel-caption">
                        <h1 class="wow zoomInRight" data-wow-delay="0.2s" data-wow-duration="2s">Meet Your Local Experts</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="p_band_38wP p_narrow_cNBm contactinfo_contactpage">
        <div class="p_container_2yE8">
            <div class="p_expert-locator_1UXs">
                ...
                <div class="p_search-form_Z_AT wow fadeInUp" data-wow-delay="0.3s" data-wow-duration="2s" style="visibility: visible; animation-duration: 2s; animation-delay: 0.3s; animation-name: fadeInUp;">
                    <label>Find your local experts</label>
                    <div class="p_search-bar-container_DWxI">
                        <form class="p_search-bar_1i-Z"><span class="p_visually-hidden_1Vqi"><label for="expert-search-bar-input">Enter postcode</label></span><input type="text" id="myInput" placeholder="Ex: 10001" class="p_lpe-search-field_3Ys0" name="postcode">
                        <button data-testid="expert-search-bar-button" class="p_search_2IlK" type="submit">Search</button>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <div class="p_band_38wP p_alternate_w8AS contactinfo_contactpage">
        ...
        <div class="p_container_2yE8">
            <div class="p_intro_30fb p_text-container_3rf0 wow fadeInRight" data-wow-delay="0.3s" data-wow-duration="2s" style="visibility: visible; animation-duration: 2s; animation-delay: 0.3s; animation-name: fadeInRight;">
            ...
            <div class="p_container_25sH" id="finder">
                ...
                <div class="p_item_1WHE col-xs-6 col-sm-4 col-md-2 wow fadeInLeft searching-element" data-postcode="<?php echo e($expert->postcode); ?>" data-wow-delay="0.3s" data-wow-duration="2s" style="visibility: visible; animation-duration: 2s; animation-delay: 0.3s; animation-name: fadeInLeft;">
                            ...
                            <div class="p_thumbnail_3_IK">
                                <picture>
                                    ...
                                    <!-- <img src="<?php echo e(asset($expert->img)); ?>"
                                         ...
                                         <img src="<?php echo e(asset('web/images/1488.gif')); ?>" class="lazy" data-src="<?php echo e(asset($expert->img)); ?>" alt="" />
...
<?php echo $__env->make('web.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/maplin/resources/views/web/book_expert.blade.php ENDPATH**/ ?>