                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="item">
                            ...
                            <img src="<?php echo e(asset('web/images/1488.gif')); ?>" class="lazy"
                                data-src="<?php echo e(asset($getOneExpert->img)); ?>" alt="" />
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-4 col-xs-4">
                                            <div class="latest-img-sec">
                                                <img src="<?php echo e(asset($value->img)); ?>" class="img-responsive"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('web.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\abeer.khan\Desktop\huzaifa\maplin\resources\views/web/book_expert_detail.blade.php ENDPATH**/ ?>