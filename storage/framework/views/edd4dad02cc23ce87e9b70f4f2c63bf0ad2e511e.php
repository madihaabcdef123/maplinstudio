<?php $__env->startSection('content'); ?>
    ...
    <section class="jobDetails opportunities_sec all-section">
        ...
        <div class="container">
            <div class="col-md-12 col-xs-12 col-sm-9 n-featured-jobs">
                        ...
                        <div class="n-job-detail">
                            <ul class="list-inline">
                                <li class="n-job-title-box">
                                    ...
                                    <p><span> <i class="fa fa-building" aria-hidden="true"></i>  <a href=""> <?php echo e($job->role_location); ?> </a>  </span></p>
                                    <p><span> <i class="fa fa-money"></i> <a href=""> <?php echo e($job->starting_salary); ?> - <?php echo e($job->ending_salary); ?></a></span></p>
                                    <p><span> <i class="fa fa-map-marker" aria-hidden="true"></i> <?php echo e($job->location); ?></a></span></p>
                                </li>
                            </ul>
                            <a href="" data-toggle="modal" data-target="#modalForm" class="TopBtn2 tc-image-effect-circle" > Apply Now</a>
...
<?php echo $__env->make('web.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/maplin/resources/views/web/career_detail.blade.php ENDPATH**/ ?>