      ...
      <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="item active">
            ...
            <img src="<?php echo e(asset('web/images/808.gif')); ?>" class="head_lazy" data-src="<?php echo e(asset('web/images/proj-ban.png')); ?>" width="100%">
        ...
        <div class="col-md-9 col-sm-9">
          <div class="detail-content-sec">
            ...
            <div class="proShowCase">
              <div class="slider-for wow fadeInLeft"  data-wow-delay="0.2s" data-wow-duration="2s">
                ...
                <?php if($news_details): ?>
                    ...
                    <div class="item">
                      <img src="<?php echo e(asset($image->path)); ?>" alt="<?php echo e(Helper::config('websitename')); ?>" class="img-responsive">

                      <!-- <img src="<?php echo e(asset('web/images/1488.gif')); ?>" class="lazy" data-src="<?php echo e(asset($image->path)); ?>" alt="<?php echo e(Helper::config('websitename')); ?>" /> -->

                      <div class="overlay-icon-fancy">
                        <a data-fancybox="gallery" href="<?php echo e(asset($image->path)); ?>"><i class="fa fa-arrows" aria-hidden="true"></i></a>
                      </div>
                    </div>
              ...
              <div class="slider-nav wow fadeInLeft"  data-wow-delay="0.3s" data-wow-duration="3s">
                <?php if($gallery): ?>
                    <?php $__currentLoopData = $gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <div class="row">
                    <div class="col-md-4 col-sm-4">
                      <div class="latest-img-sec">
                        <img src="<?php echo e(asset($project->img)); ?>" class="img-responsive" alt="<?php echo e(Helper::config('websitename')); ?>">
                      </div>
                    </div>
...
<?php echo $__env->make('web.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/maplin/resources/views/web/news-details.blade.php ENDPATH**/ ?>