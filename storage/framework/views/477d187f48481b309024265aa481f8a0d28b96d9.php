    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                ...
                <img src="<?php echo e(asset('web/images/808.gif')); ?>" class="head_lazy" data-src="<?php echo e(asset($project->img)); ?>"
                    width="100%">
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                ...
                <div class="detail wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.3s">
                    <h2><h2><?php echo e($project->name); ?> Description</h2></h2>
...
<?php echo $__env->make('web.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Mini\V3\maplin\resources\views/web/news_details.blade.php ENDPATH**/ ?>