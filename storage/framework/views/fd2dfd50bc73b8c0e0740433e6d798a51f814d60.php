                ...
                <div class="col-md-10 col-md-offset-1">
                    <div class="col-sm-3 col-xs-12">
                        <div class="footer-nav footer-content">
                            <div class="row">
                                <h6 class="wow fadeInUp" data-wow-delay="0.3s" data-wow-duration="2s">Navigation</h6>
                    ...
                    <div class="col-sm-6 col-xs-12">
                        <div class="footer-newsletter footer-content">
                            ...
                            <form class="wow fadeInLeft" data-wow-duration="2s" action="<?php echo e(route('newsletter_submit')); ?>"
                                method="POST">
                                <?php echo csrf_field(); ?>
...
</footer><?php /**PATH /opt/lampp/htdocs/maplin/resources/views/web/layouts/footer.blade.php ENDPATH**/ ?>