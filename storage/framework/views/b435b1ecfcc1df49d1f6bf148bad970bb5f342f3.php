...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <body id="main-container" class="default dark compact-menu" >
        ...
        <footer class="site-footer">
            2022 &copy; <?php echo e(Helper::config('websitename')); ?> Dashboard
        </footer>
        <?php endif; ?>
        <!-- END: Footer-->
...
<?php /**PATH C:\Users\abeer.khan\Desktop\huzaifa\maplin\resources\views/layouts/main.blade.php ENDPATH**/ ?>