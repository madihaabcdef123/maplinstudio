                ...
                <div class="col-lg-10 col-md-10 col-xs-12">
                    <nav id="menu" class="navbar custom-navbar navbar-expand-lg navbar-light bg-light">
                        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                            ...
                            <li class="nav-item <?php echo e((isset($menu) && $menu == 'planning'?'active':'')); ?>">
                                <a class="nav-link" href="<?php echo e(route('planning')); ?>">Planning</a>
                            </li>
                            <li class="nav-item <?php echo e((isset($menu) && $menu == 'projects'?'active':'')); ?>">
                                <a class="nav-link " href="<?php echo e(route('project')); ?>">Projects</a>
                            </li>
                            <li class="nav-item <?php echo e((isset($menu) && $menu == 'studio'?'active':'')); ?>">
                                <a class="nav-link " href="<?php echo e(route('studio')); ?>">Studio</a>
                            </li>
                            <li class="nav-item <?php echo e((isset($menu) && $menu == 'about'?'active':'')); ?>">
                                <a class="nav-link " href="<?php echo e(route('about')); ?>">about</a>
                            </li>
                            <li class="nav-item <?php echo e((isset($menu) && $menu == 'news'?'active':'')); ?>">
                                <a class="nav-link " href="<?php echo e(route('news')); ?>">News</a>
                            </li>
                            <li class="nav-item <?php echo e((isset($menu) && $menu == 'career'?'active':'')); ?>">
                                <a class="nav-link " href="<?php echo e(route('career')); ?>">Careers</a>
                            </li>
                            <li class="nav-item <?php echo e((isset($menu) && $menu == 'contact'?'active':'')); ?>">
                                <a class="nav-link " href="<?php echo e(route('contact')); ?>">Contact Us</a>
                            </li>
                            <li class="nav-item <?php echo e((isset($menu) && $menu == 'book_expert'?'active':'')); ?>">
...
</header><?php /**PATH E:\Mini\V3\maplin\resources\views/web/layouts/header.blade.php ENDPATH**/ ?>