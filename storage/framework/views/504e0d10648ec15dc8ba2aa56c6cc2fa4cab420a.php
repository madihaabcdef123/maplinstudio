        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                ...
                <img src="<?php echo e(asset('web/images/808.gif')); ?>" class="head_lazy"
                    data-src="<?php echo e(asset('web/images/proj-ban.png')); ?>">
        ...
        <div class="row">
            ...
            <div class="description-sec-main">
                            ...
                            <div class="slider-for wow fadeInLeft" data-wow-delay="0.2s" data-wow-duration="2s">
                                ...
                                <div class="item">
                                    ...
                                    <div class="overlay-icon-fancy">
                                        <a data-fancybox="gallery" href="<?php echo e(asset($image->path)); ?>"><i
                        ...
                        <div class="slider-nav wow fadeInLeft" data-wow-delay="0.3s" data-wow-duration="3s">
                            ...
                            <div class="item">
                                ...
                                <img src="<?php echo e(asset('web/images/1488.gif')); ?>" class="lazy"
                                    data-src="<?php echo e(asset($image->path)); ?>" alt="" />
                ...
                <div class="property-description-sec wow fadeInLeft" data-wow-delay="0.3s" data-wow-duration="3s">
                    ...
                    <?php echo html_entity_decode($project->details) ?>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('web.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/maplin/resources/views/web/project_detail.blade.php ENDPATH**/ ?>